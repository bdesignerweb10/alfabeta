	...
	<div class="container-fluid footer">
		<div class="row">
			...
			<div class="col-sm-4 acesso-footer">
				<div class="fb-page" data-href="https://www.facebook.com/colegioalfabeta/" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/colegioalfabeta/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/colegioalfabeta/">Colégio Alfa.Beta Bauru</a></blockquote></div>
			</div>
		</div><!-- row -->
		<div class="row" style="background-color: #fff; ">			
			<div class="col-sm-12">
				<p class="footer-end">Rua Rubens Pagani, 3-40, Jd Estoril,  CEP 17016-210, Bauru/SP<br />
				(14) 3227-3027 / (14) 99696-7814</p>
				<p class="footer-dev" data-toggle="tooltip" data-placement="top" data-html="true" title="Telefone: (19) 99897-0090 / E-mail: bdesigner_web@hotmail.com">Website desenvolvido por Bruno Gomes <br />
				Todos os direitos reservados. Colégio Alfa.Beta - 2019</p>
			</div>		
		</div>	
	</div><!--container -->
