...
<head>
	...
	<meta name="description" content="Colégio Alfa Beta, a Educação do seu filho começa aqui!" />
	<meta name="keywords" content="Colégio, Educação, Escola, Alfa, Beta, AlfaBeta, Bauru" />
	<meta name="author" content="Bruno Gomes"/>

	<meta name="robots" content="index, follow" />
	<meta name="googlebot" content="index, follow" />
	
	<title>Colégio Alfa Beta</title>
...
<body>
	<div class="container-fluid topo">
		<div class="row topo-fundo">
			<div class="col-sm-4 info-topo">
				<a href="http://www.aquitemanglo.com.br/" target="_blank"><p class="info-sis"><img src="img/anglo.png"> Sitema Anglo de ensino</p></a>
			</div>		
			<div class="col-sm-3"></div>	
			<div class="col-sm-3 info-topo">
				<p class="info-tel">Bauru / SP <span>&#173;	(14) 3227-3027</span></p>
			</div>
			<div class="col-sm-2 info-area">
				<p class="areaaluno"><a href="http://areadoaluno.alfabeta.com.br/" target="_blank"><i class="fa fa-lock"></i> Área do Aluno</a></p>
			</div>
		</div>	
